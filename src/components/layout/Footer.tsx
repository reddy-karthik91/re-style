    ...
    <footer className="bg-white border-t border-gray-100 py-12">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
          ...
          <nav>
            <ul className="flex flex-wrap gap-x-8 gap-y-4 text-[10px] font-bold uppercase tracking-[0.2em] text-gray-400">
              <li>
                <Link
                  href="/about"
              ...
              <li>
                {/* Pointing to the specific section on the About page */}
                <Link
                  href="/shipping"
                  className="hover:text-black transition-colors"
                >
          ...
          <div className="flex items-center space-x-6">
            <Link
              href="#"
              className="text-xs text-gray-400 hover:text-black uppercase tracking-tighter"
            >
              Instagram
            </Link>
            <Link
